...
- [0. Кратко](#0-Кратко)
    - [0.1 Создание образа](#01-Создание-образа)
    - [0.2 Команды Dockerfile](#02-Команды-dockerfile)
    - [0.3 Использование `"`, `/`](#03-Использование--)
    - [0.4 CMD vs ENTRYPOINT](#04-cmd-vs-entrypoint)
    - [0.5 ADD vs COPY](#05-add-vs-copy)
- [1. Основы](#1-Основы)
...
- [8. Best practices](#8-best-practices)
    - [8.1 Общие рекомендации](#81-Общие-рекомендации)
    - [8.2.Рекомендации по командам](#82Рекомендации-по-командам)
...
Работа с пробелами: обернуть в `"`, команды имеют формы.
...
клманда `VOLUME`: создать, добавить файл, посмотреть в запущенном, в томах
...
#### 8.1.3 Dockerfile через конвейер (pipe) stdin

##### 8.1.3.1 Конвейер (pipe)
...
##### 8.1.3.2 Dockerfile из stdin без отправки контекста
...
##### 8.1.3.3 Dockerfile из stdin с локальным контекстом
...
##### 8.1.3.4 Dockerfile из stdin с удаленным контекстом
...
#### 8.1.4 Исключайте лишние файлы через .dockerignore

#### 8.1.5 Используйте multi-stage build
...
#### 8.1.6 Не используйте ненужные зависимости

Уменьшение сложности, размера и т. п.

#### 8.1.7 Декомпозируйте контейнеры/приложения
...
#### 8.1.8 Минимизируйте количество слоев
...
#### 8.1.9 Сортируйте агрументы по алфавиту
...
#### 8.1.10 Следите за порядком команд (кеширование)
...
#### 8.1.11 Используйте непривилегированных пользователей
...
#### 8.1.12 Версионирование образов
...
#### 8.1.13 Не храните секреты в образах
...
#### 8.1.14 Используйте статический анализ Dockerfile и сканеры уязвимости

[hadolint](https://hadolint.github.io/hadolint/)

[варианты сканеров](https://habr.com/ru/company/wunderfund/blog/586778/)

#### 8.1.15 Правильно выбирайте команду для запуска основного процесса внутри контейнера

Сам Docker, системы оркестрации управляют контейнерами через отправку сигналов внутрь контейнера.



### 8.2.Рекомендации по командам
...
##### 8.2.3.3 Использование конвейеров (pipe)
